...
echo "My name is also ${NAME}"

# USER INPUT
# read -p "Enter your name: " NAME
echo "Hello $NAME. nice to meet you!"

# SIMPLE IF-ELSE and ELSE-IF (elif) STATEMENT
if [ "$NAME" == "Darryl" ]
then
  echo "Your name is Darryl"
elif [ "$NAME" == "John" ]
then
  echo "Your name is John"
else
  echo "Your name is not Darryl or John"
fi
...
# val1 -ge val2 Return true if val1 is greater than or equal to val2
